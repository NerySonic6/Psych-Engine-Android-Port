...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['NerySonicawesome', 0.6], //From 50% to 59%
		['NerySonicawesome', 0.69], //From 60% to 68%
		['NerySonicawesome', 0.7], //69%
		['NerySonicawesome', 0.8], //From 70% to 79%
		['NerySonicawesome', 0.9], //From 80% to 89%
		['Sick! NerySonicawesome', 1], //From 90% to 99%
		['Perfect!! NerySonicawesome', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
